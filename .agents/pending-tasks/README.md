...
| **[NEXT]** Minimal always-on infrastructure rebuild | [minimal-always-on-infra/](minimal-always-on-infra/task.md) | Eliminates accidental API-edge recreation and drives the remaining fixed baseline down | **critical** |
...
| Multi-tenant Git/CI fallback hub (GitHub Actions outage resilience) | [git-ci-fallback/](git-ci-fallback/task.md) | +revenue (sellable per tenant) | high |
